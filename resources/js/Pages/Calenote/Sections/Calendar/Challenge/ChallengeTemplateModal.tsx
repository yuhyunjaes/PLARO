            ...
            <div className="w-full max-w-[560px] max-h-[92vh] rounded bg-gray-100 dark:bg-gray-950 border border-gray-300 dark:border-gray-800 p-4 md:p-5 flex flex-col" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="space-y-4 mt-3 flex-1 overflow-y-auto hidden-scroll pr-1">
                    <div className="space-y-2">
                        ...
                        <div className="max-h-[38vh] md:max-h-[280px] rounded border border-gray-300 dark:border-gray-800 bg-white dark:bg-gray-950 overflow-x-hidden overflow-y-auto grid grid-cols-1 gap-2 p-2">
                            {templatesLoading ? (
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400 py-5 text-center">표시할 템플릿이 없습니다.</p>
                            ) : (
