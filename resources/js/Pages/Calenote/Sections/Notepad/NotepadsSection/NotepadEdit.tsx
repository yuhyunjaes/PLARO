            ...
            {(editId === notepadId) && (
                ...
                >
                    ...
                    <button onClick={(e) => {
                        e.stopPropagation();
                        deleteNotepad();
                    }} className="btn transition-colors duration-300 w-full flex justify-start items-center px-0 py-2 text-red-500 hover:text-red-50 hover:bg-red-500/80 space-x-1">
