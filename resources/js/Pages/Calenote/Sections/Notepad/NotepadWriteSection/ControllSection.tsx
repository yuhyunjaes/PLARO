...
export default function ControlSection({ notepadShareToggle, setNotepadShareToggle, notepadContentsToggle, setNotepadContentsToggle, currentTitle, setCurrentTitle, saveStatus, notepadLiked, setNotepadLiked, uuid } : ControlSectionProps) {
        ...
        <div className="flex justify-between items-center px-5 border border-t-transparent border-x-transparent bg-white dark:bg-gray-950 py-2 border-b-gray-300 dark:border-b-gray-800 sticky top-0 z-[1]">
            <div className="flex space-x-2 items-center max-w-1/2">
                ...
                <input
                    ...
                    type="text" name="" id="" className="normal-text font-semibold text-xl truncate border-0 outline-none max-w-5/12" value={currentTitle}/>
