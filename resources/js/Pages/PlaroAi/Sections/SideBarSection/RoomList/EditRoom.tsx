            ...
            <div className="p-2">
                {
                    (editStatus === "update") ? (
                        <button onClick={() => {
                            ...
                            handleEditRoom();
                        }} className="btn transition-colors duration-150 w-full flex justify-start items-center px-0 py-2 text-green-500 hover:text-green-50 hover:bg-green-500/80 space-x-1">
                        ...
                        <button onClick={EditTitle} className="btn transition-colors duration-150 w-full flex justify-start items-center px-0 py-2 text-gray-950 dark:text-white hover:bg-gray-950/10 dark:hover:bg-gray-600">
                ...
                <button onClick={deleteRoom} className="btn transition-colors duration-150 w-full flex justify-start items-center px-0 py-2 text-red-400 hover:bg-red-500/80 hover:text-red-50">
