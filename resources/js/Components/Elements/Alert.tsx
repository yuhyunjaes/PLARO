...
export default function Alert({ setAlerts, type, message, width = 0 }: AlertProps) {
    ...
    return (
        <div
            className={`fixed top-0 md:top-[70px] flex duration-300 transition-[width] justify-between items-center z-[5] right-0 ${style.background} ${style.color} p-5 shadow-lg ${(timer >= 100) ? "animate-out-modal" : "animate-in-modal"}`}
